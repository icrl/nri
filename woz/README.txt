...
4.You can type in numbers from 1-21 in the terminal window as your input choice. 
	These numbers correspond to sentences in dialog dictionary (in thread.py).
