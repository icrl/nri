...
##-------------------------------------------------------------------------------------
   ...
   def teaching4():
      ...
      angleLists  = [[0.0*almath.TO_RAD],
                     ...
                     [78.0*almath.TO_RAD, 81.0*almath.TO_RAD, 81.0*almath.TO_RAD, 63.5*almath.TO_RAD, 78.0*almath.TO_RAD],
                     [4.0*almath.TO_RAD, 2.0*almath.TO_RAD, 3.0*almath.TO_RAD, 1.8*almath.TO_RAD, 4.0*almath.TO_RAD],
                     [-27.0*almath.TO_RAD, -33.0*almath.TO_RAD, -33.0*almath.TO_RAD, -42.6*almath.TO_RAD, -27.0*almath.TO_RAD],
                     [-60.0*almath.TO_RAD, -61.0*almath.TO_RAD, -61.0*almath.TO_RAD, -51.5*almath.TO_RAD, -60.0*almath.TO_RAD],
                     [48.0*almath.TO_RAD, 52.0*almath.TO_RAD, 52.0*almath.TO_RAD, 16.6*almath.TO_RAD, 48.0*almath.TO_RAD],
                     
                     [72.9*almath.TO_RAD, 62.0*almath.TO_RAD, 48.9*almath.TO_RAD, 37.5*almath.TO_RAD, 48.9*almath.TO_RAD],
                     [-1.9*almath.TO_RAD, 7.0*almath.TO_RAD, 2.9*almath.TO_RAD, -16.5*almath.TO_RAD, 2.9*almath.TO_RAD],
                     [19.2*almath.TO_RAD, 58.0*almath.TO_RAD, 119.2*almath.TO_RAD, 119.5*almath.TO_RAD, 119.2*almath.TO_RAD],
                     [54.7*almath.TO_RAD, 80.0*almath.TO_RAD, 87.7*almath.TO_RAD, 87.6*almath.TO_RAD, 87.7*almath.TO_RAD],
                     [-46.6*almath.TO_RAD, -55.0*almath.TO_RAD, 69.6*almath.TO_RAD, 100.5*almath.TO_RAD, 69.6*almath.TO_RAD]]
      #*almath.TO_RAD
      timeLists   = [[1.0],
                     [0.5],
      ...
      # the post is so it happens at the same time as the speech
      motionProxy.post.angleInterpolation(names, angleLists, timeLists, isAbsolute)
      tts.say("I think there's something about the relationship between the one and the six, but I don't know what.")
      time.sleep(1.0)
...
##_________________________________NEW GESTURES______________________________________##
...
##__________________________________MENUS_____________________________________##
   ...
   bodymenu.add_separator()
   bodymenu.add_command(label="handOpen", command=openHands)
   bodymenu.add_separator()
   bodymenu.add_command(label="handClose", command=closeLHand)
...
##   teachmenu.add_separator()
##   teachmenu.add_command(label="teach4", command=teaching4)
##   teachmenu.add_separator()
##   teachmenu.add_command(label="teach All", command=teachAll)
   teachmenu.add_separator()
   teachmenu.add_command(label="Look at nails (L)", command=lookAtNailsLeft)
