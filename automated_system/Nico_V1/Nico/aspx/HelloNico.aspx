...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container" id="overalldiv"> 
        ...
        <div class="row">
            <div  class=".col-xs-12 center-block">
                <img id="thinking" src='../content/img/loading/larger_coloredcircles_thinking.gif' style="display:none;width:150px; height:150px;position:relative;"/>
                <br />
            </div>
        </div>
